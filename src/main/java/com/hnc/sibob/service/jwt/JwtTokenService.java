...
// import static com.hnc.sibob.service.jwt.constant.JwtValue.*;
//
...
//
// 	// JWT 토큰 생성
// 	public String createJwt(Long memberId, Authority role) {
// 		Date now = new Date();
// 		return Jwts.builder()
...
// 		return request.getHeader(X_ACCESS_TOKEN.label);
// 	}
//
// 	/*
// 		JWT에서 유저권한 추출
...
//  	*/
// 	public Authority getMemberRole() throws BaseException {
// 		//1. JWT 추출
...
// 		// 3. userIdx 추출
// 		// ptpt: Object To Long
// 		return Authority.valueOf(String.valueOf(claims.getBody().get("role")));
// 	}
//
// 	/*
// 		JWT에서 userIdx 추출
